...
@Override
    ...
    checkBox1.setOnCheckedChangeListener(listener1);
        ...
        RadioGroup.OnCheckedChangeListener listener3 = new RadioGroup.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                int drawableId = 0; switch (checkedId) {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) { String s = "checkBox1=" + checkBox1.isChecked() + " ";
            s += "switch1=" + switch1.isChecked() + " ";
        s += "radioGroup1=";
        switch (radioGroup1.getCheckedRadioButtonId()) {
            case R.id.radioRed: s += "red "; break;
            case R.id.radioYellow: s += "yellow "; break;
            case R.id.radioBlue: s += "blue "; break; } switch (radioGroup2.getCheckedRadioButtonId()) {
            case R.id.radioCat: s += "cat"; break; case R.id.radioDog: s += "dog"; break;
